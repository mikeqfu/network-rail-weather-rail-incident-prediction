...
def create_loc_name_replacement_dict(k=None, as_dataframe=False):
    ...
    location_name_replacement_dict = {
        ...
        'Aberthaw Rec Sdgs': 'Aberthaw Reception Sidings',
        'Aldwarke U.E.S.': 'Aldwarke UES',
        ...
        'Ashton In Makerfield K.S.': 'Ashton In Makerfield Kelbit Sidings',
        'Avonmouth (Fastline)': 'Avonmouth Bennets Fastline',
        'Awre Jct': 'Awre',
        'Aylesbury (Sdgs 1-7)': 'Aylesbury Sidings 1-7',
        'BARONS COURT LT': 'Barons Court LT',
        'BARROW HILL UP SDG NO 1': 'Barrow Hill Up Siding 1 Freightliner Heavy Haul',
        ...
        'Banbury Reservoir Rland A': 'Banbury Reservoir Redland Aggregates',
        ...
        'Berkeley C.E.G.B.': 'Berkeley CEGB',
        'Blackburn Pg Fogarty': 'Blackburn PG Fogarty',
        'Bletchley R.M.C.': 'Bletchley RMC',
        'Briggs I.C.I. Sdgs': 'Briggs ICI Sidings',
        'Bristol Kingsland Rd S&Te': "Bristol Kingsland Road Signalling & Telecommunications Engineer's Sidings",
        'Broxbourne Redland Aggs': 'Broxbourne Redland Aggregates',
        'Burngullow E.C.C.': 'Burngullow English China Clay',
        'Bury St. Edmunds Cmd': 'Bury St Edmunds Carriage Maintenance Depot',
        'Buxton Urs': 'Buxton Up Relief Sidings',
        'CARLISLE NY DBS LOCO MAIN PT': 'Carlisle New Yard DB Schenker Locomotive Maintenance Point',
        'CLAPHAM JUNCTION SIG T147': 'Clapham Junction Signal T147',
        'CLHMABL': 'Chelmsford Arbour Lane',
        'CREWE SSN SIG. NH19': 'Crewe Signal NH19',
        'Calvert (Shanks&Mcewan)Fl': 'Calvert Shanks & McEwan Freightliner',
        'Cambridge T.&R.S.M.D.': 'Cambridge Traction & Rolling Stock Maintenance Depot',
        'Canada water (ELL)': 'Canada Water',
        'Carlisle Kingmoor Jcn': 'Kingmoor Junction',
        'Carlisle Kingmoor Sdg(DRS)': 'Kingmoor Siding DRS',
        'Carlisle Kingmoor Tmd(DRS)': 'Kingmoor Traction Maintenance Depot (DRS)',
        ...
        'Corby B.S.C.': 'Corby BSC',
        'Corby Bsc Automotive Terml': 'Corby BSC Automotive Terminal',
        'Craigo C.E.': "Craigo Civil Engineer's Sidings",
        'Crewe Bas Hall S.S.M.': 'Crewe Basford Hall SSM',
        'Crewe C.S. (L&NWr Site)': 'Crewe Carriage Sidings L&NWR Site',
        'Crewe Sorting Sdgs Nth SB': 'Crewe Sorting Sidings North',
        'Cwmbargoed Opencast Colly.': 'Cwmbargoed Opencast Colliery',
        'DERBY RTC (NETWORK RAIL)': 'Derby RTC (Network Rail)',
        'Dagenham Dock A.R.C.': 'Dagenham Dock ARC',
        'Dainton T': 'Dainton Tunnel',
        'Dalston Junction (ELL)': 'Dalston Junction (East London Line)',
        'Dalzell B.S.C.': 'Dalzell BSC',
        'Daventry DRS (Malcolm W H)': 'Daventry International Rail Freight Terminal WH Malcolm/DRS',
        'Daventry Int Rft Recep RFD': 'Daventry International Rail Freight Terminal Reception Railfreight Distribution',
        'Derby North Doc Sdgs': 'Derby North Dock Sidings',
        "Ditton (O'Connor Sdgs)": "Ditton O'Connor Sidings",
        'Ditton (Oconnor) Fliner': "Ditton O'Connor Sidings Freightliner",
        'Dollands Moor T.P.L.': 'Dollands Moor East',
        'Doncaster ECD Powertrack': 'Doncaster Electrification Construction Depot Powertrack',
        'Doncaster Rfs Engineering': 'Doncaster RFS Engineering/Wabtec',
        # 'DORCHESTER SOUTH ISU (CE)': "Dorchester South Engineer's Sidings",
        'Doncaster Up Decoy (Fastline)': 'Doncaster Up Decoy Freightliner',
        "Dr Day'S Jn": "Dr Day's Junction",
        'East Cowton Xovers': 'Darlington East Cowton Crossovers',
        'Eastleigh Works-Alstom-Fl': 'Eastleigh Works Alstom Freightliner',
        'Epsom - Up Sidings': 'Epsom Up Sidings',
        ...
        'Gladstone Dock BT (Fastline)': 'Gladstone Dock',
        'Gobowen Run Round/Ce Sdgs': "Gobowen Run Round/Civil Engineer's Sidings",
        'Grangemouth Fpa (DRS)': 'Grangemouth Docks FPA DRS',
        ...
        'Grove Park C.S.D.': 'Grove Park Carriage Servicing Depot',
        "Guide Bridge B'Sde Sdgs": 'Guide Bridge Brookside Sidings',
        'Guildford Up Recp': 'Guildford Up Reception',
        'HIGH MEADS JN': 'High Meads Junction',
        'Hamilton Steele E.G.': 'Hamilton Steele EG',
        'Harrow & Wealdstone D.C.': 'Harrow & Wealdstone DC',
        "Hayes & H'Ton Tarmac Sdgs": 'Hayes & Harlington Tarmac Sidings',
        'Heysham Harbour [station]': 'Heysham Port [station]',
        'Hitchin Up Scrap Siding (Advenza': 'Hitchin Advenza Freight',
        'Hoo Junction Signal Nk1611': 'Hoo Junction Signal NK1611',
        'Hope (Earles Sidings) EWS': 'Earles Sidings (Hope) English Welsh & Scottish Railway',
        ...
        'Immingham B.S.C. Ore Tml': 'Immingham BSC Ore Terminal',
        ...
        'Immingham Rec Sdg (GBRF)': 'Immingham Reception Sidings GB Railfreight',
        'KNOTTINGLEY SIG FE6418': 'Knottingley Signal FE6418',
        'Kings Norton C.T.': 'Kings Norton Car Terminal',
        ...
        'Lackenby B.S.C.': 'Lackenby BSC',
        'Leicester Car Sidings': 'Leicester Carriage Sidings',
        'Leith Docks F.P.A.': 'Leith Docks Forth Ports',
        'Leyland B. Leyland': 'Leyland British Leyland',
        'Lichfield T.V. Jn.': 'Lichfield Trent Valley Junction',
        'Lichfield Trent Valley Hl': 'Lichfield Trent Valley High Level',
        'Linclncen': 'Lincoln [Central]',
        'Liverpool Euro Metal(Mdhc)': 'Liverpool European Metals Mersey Dock & Harbour Company',
        'Liverpool South Pw Ll': 'Liverpool South Parkway Ll',
        ...
        'Old Oak Common EMU Depot': 'Old Oak Common Electric Multiple Unit Depot',
        'Old Oak Common H.S.T.D.': 'Old Oak Common High Speed Train Depot',
        "P'Boro Eastfield Jn.": 'Peterborough Eastfield Junction',
        ...
        'Peak Forest (Fhh Fuel Pt)': 'Peak Forest Freightliner Heavy Haul Fuel Point',
        'Peak Forest R.M.C. Sdgs': 'Peak Forest RMC Sidings',
        'Pendleton (Brindle Heath)': 'Pendleton',
        'Portbury Coal Terml (Fastline)': 'Portbury Coal Terminal Fastline Freight',
        "Princes R'Boro Ace": 'Princes Risborough Area Civil Engineer',
        ...
        'Rdg 4A&4B': 'Reading Platforms 4A/4B',
        'Redcar B.S.C. (Min.T.)': 'Redcar BSC Mineral Terminal',
        'Redcar B.S.C. Ore T.': 'Redcar BSC Ore Terminal',
        'Richmndnl': 'Richmond North London Line',
        'Ripple Lane Advenza Frt': 'Ripple Lane Advenza Railfreight',
        'Rugeley B PS (FGD) (GBRF)': 'Rugeley Power Station GB Railfreight',
        'SELHURST SHUNT SIG 1051': 'Selhurst Shunt Signal 1051',
        'Santon F.O.T.': 'Scunthorpe Santon Foreign Ore Terminal',
        ...
        'Seaforth C.T.(Fliner)': 'Seaforth Container Terminal Freightliner',
        'Selby (GB Railfreight)': 'Selby GB Railfreight',
        'Shadwell (ELL)': 'Shadwell',
        'Shields T.M.D. (E)': 'Shields Traction Maintenance Depot',
        ...
        'Southminster C.E.G.B.': 'Southminster CEGB',
        'St Blazey L I P': 'St Blazey Loco Inspection Point',
        'St Leonards Eng.Ltd (GBRF)': 'St Leonards Railway Engineering GB Railfreight',
        'St Leonards Warrior Sq': 'St Leonards Warrior Square',
        ...
        'St Pancras International (MML)': 'St Pancras International',
        'St Philips Mrsh H S T D': 'St Philips Marsh HST Depot',
        'Stanlow & T Shell Sdgs': 'Stanlow & Thornton Shell Sidings',
        ...
        'Three Bridges P & Md': "Three Bridges P & MD/Civil Engineer's Sidings",
        ...
        'Warrington Latchford Sdgs (FLHH)': 'Warrington Latchford Sidings Freightliner Heavy Haul',
        'Warrington Royal Mail (Ew)': 'Warrington Royal Mail Terminal',
        'Warrington Royal Mail (Gb)': 'Warrington Royal Mail Terminal GB Railfreight',
        ...
        'Welwyn G.C C.S.D.': 'Welwyn Garden City Carriage Servicing Depot',
        ...
        'Wootton Bassett F.Y.': 'Wootton Bassett Foster Yeoman',
...
def create_loc_name_regexp_replacement_dict(k=None, as_dataframe=False):
    ...
    location_regexp_replacement_dict = {
        ...
        re.compile(' S\.B\.?| Sb| S B| Ss| S\.S\.$'): ' Signal Box',
