...
from utils import cdd, get_angle_of_line_between, load_pickle, save_fig, save_pickle
    ...
    if os.path.isfile(path_to_pickle) and not update:
        ...
        try:
            ...
            def integrate_nip_gridded_weather_obs(grids, period, location):
                ...
                :param location: e.g. location = non_ip_data.StanoxSection.iloc[12]
                :return:
                """
...
def logistic_regression_model(trial_id=0,
    ...
    train_set = m_data[m_data.StartDateTime < datetime.datetime(2013, 1, 1)]
    test_set = m_data[m_data.StartDateTime >= datetime.datetime(2013, 1, 1)]
