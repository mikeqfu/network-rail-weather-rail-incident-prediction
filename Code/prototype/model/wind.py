...
def describe_explanatory_variables(mdata, save_as=".tif", dpi=None):
    ...
    plt.tight_layout()
    path_to_file_weather = cdd(prototype.utils.cd_prototype_fig_pub("Variables", "Weather" + save_as))
    ...
    plt.tight_layout()
    path_to_file_veg = prototype.utils.cd_prototype_fig_pub("Variables", "Vegetation" + save_as)
