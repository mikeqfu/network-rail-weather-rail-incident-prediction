...
class Vegetation:
    ...
    def __init__(self):
        ...
        self.DatabaseEngine = establish_mssql_connection(database_name=self.DatabaseName)
    ...
    def read_table(self, table_name, index_col=None, route_name=None, schema_name='dbo', save_as=None,
        ...
        **Example**::
            ...
            data = vegetation.self.read_table(table_name, index_col, route_name, schema_name, save_as,
                                             update)
        """
        ...
        data = pd.read_sql(sql=sql_query, con=self.DatabaseEngine, index_col=index_col, **kwargs)
    ...
    def get_primary_key(self, table_name):
        ...
        **Example**::
            ...
            pri_key = vegetation.get_primary_key(table_name)
            print(pri_key)
        """
    ...
    def update_vegetation_view_pickles(self, route_name=None, update=True, pickle_it=True, verbose=True):
        ...
        **Example**::
        ...
        if confirmed("To update the View pickles of the NR_Vegetation data?"):
            ...
            _ = self.view_hazardous_trees(route_name, update, pickle_it, verbose)
            _ = self.view_hazardous_trees('Anglia', update, pickle_it, verbose)

            _ = self.view_vegetation_condition_per_furlong(route_name, update, pickle_it, verbose)

            _ = self.view_vegetation_coverage_per_furlong(route_name, update, pickle_it, verbose)

            _ = self.view_nr_vegetation_furlong_data(update, pickle_it, verbose)
